...
function generatepress_sites_do_site_options_export( $data ) {
	...
	unset( $all_plugins['gp-premium/gp-premium.php'] ); // Ignore GP Premium.
	unset( $all_plugins['easy-theme-and-plugin-upgrades/init.php'] ); // Ignore Easy Theme and Plugin Upgrades.
	unset( $all_plugins['widget-importer-exporter/widget-importer-exporter.php'] ); // Ignore Widget Import Exporter
	unset( $all_plugins['worker/init.php'] ); // Ignore ManageWP Worker.
